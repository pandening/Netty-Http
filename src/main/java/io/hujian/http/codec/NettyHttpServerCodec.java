 ...
 *
 */
public final class NettyHttpServerCodec extends CombinedChannelDuplexHandler<HttpRequestDecoder, HttpResponseEncoder>
     ...
     */
    public NettyHttpServerCodec(int maxInitialLineLength, int maxHeaderSize, int maxChunkSize) {
     ...
     * Creates a new instance with the specified decoder options.
     */
    public NettyHttpServerCodec(int maxInitialLineLength, int maxHeaderSize, int maxChunkSize, boolean validateHeaders) {
